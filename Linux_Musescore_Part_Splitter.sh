...
do 
	...
	musescore -o "${noX}.mscz" $file
	musescore -o "../PDF_Files/${noX}.pdf" $file
	rm $file
done
for file in ./*
do
	...
	then 
		...
		do
			...
			musescore -o "${noX}.mscz" $subFile
			musescore -o "../../PDF_Files/${file}/${noX}.pdf" $subFile
			rm $subFile
		done
		cd ..
	fi 
