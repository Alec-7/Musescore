...
do 
	...
	mscore-portable -o "${noX}.mscx" $file
done
...
do 
	...
	mscore-portable -o "${noX}.mscz" $file
	mscore-portable -o "../PDF_Files/${noX}.pdf" $file
	rm $file
done
for file in ./*
do
	...
	then 
		...
		do
			...
			mscore-portable -o "${noX}.mscz" $subFile
			mscore-portable -o "../../PDF_Files/${file}/${noX}.pdf" $subFile
			rm $subFile
		done
		cd ..
	fi 
